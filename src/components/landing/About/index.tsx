...
export default function About() {
  return (
    <Area className="bg-whiteLight" id="about">
      <div
        className={`
        flex 
        flex-row 
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <p
            ...
            `}
          >
            Nutricionista, também sou formada em técnico de nutrição e
            dietética. Meu objetivo é ajudar pessoas que buscam melhorar sua
            saúde e bem-estar por meio da alimentação. Ofereço suporte na
            reeducação alimentar, auxiliando na realização de escolhas saudáveis
            para alcançar objetivos como emagrecimento, hipertrofia, tratamento
            e prevenção de doenças, além de melhoria de sinais e sintomas, como
